...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p></p>
    <p></p>
    <asp:Button ID="AddProductBtn" runat="server" Text="Add Product" OnClick="AddProductBtn_Click" CausesValidation="true" />
    ...
    <p></p>
    <asp:Button ID="RemoveProductBtn" runat="server" Text="Remove Product" OnClick="RemoveProductBtn_Click" CausesValidation="false" />
